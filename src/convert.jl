...
Converts a passive `StateSpace` to a `PortHamiltonianStateSpace` by executing [`decompose`](@ref).
If `X` is not provided, the minimal solution of the KYP inequality is used, which is obtained by solving the ARE.
"""
